...
- [x] Construir las páginas About, Projects y Contact
- [x] Añadir estilos y diseño responsivo
- [x] Reemplazar bio, proyectos y contacto de ejemplo por los reales
- [ ] Actualizar el proyecto "E-commerce con Hostinger" cuando esté listo
- [ ] Desplegar el sitio (Vercel / Netlify / Hostinger)
